  ...
  return (
    ...
    >
      <Container>
        ...
        <p className="mx-auto mt-6 max-w-4xl rounded-2xl border border-cyan-glow/20 bg-cyan-glow/5 px-4 py-3 text-center text-sm font-medium leading-7 break-words text-ice-100 sm:mt-8 sm:px-5">
