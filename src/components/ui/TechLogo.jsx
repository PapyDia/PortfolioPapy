...
const TechLogo = forwardRef(function TechLogo(
  { label, Icon, className = '', iconClassName = '', showLabel = false, ...props },
  ref,
) {
  ...
  return (
    <span
      {...props}
      aria-label={label}
      className={`inline-flex shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-ice-300/20 bg-white/[0.04] text-ice-50 shadow-[0_0_24px_rgba(56,189,248,0.12),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-xl transition duration-300 hover:border-cyan-glow/40 hover:bg-cyan-glow/10 hover:shadow-[0_0_28px_rgba(56,189,248,0.2),inset_0_1px_0_rgba(255,255,255,0.12)] ${sizeClassName} ${className}`}
      ref={ref}
      role="img"
    >
      {Icon ? (
